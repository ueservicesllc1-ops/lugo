                ...
                <div style={{ position: 'fixed', inset: 0, zIndex: 100000, background: 'rgba(0,0,0,0.85)', display: 'flex', alignItems: 'center', justifyContent: 'center', backdropFilter: 'blur(5px)' }}>
                    <div style={{ background: '#1c1c1e', padding: '30px', borderRadius: '12px', width: '320px', border: '1px solid #333', position: 'relative', boxShadow: '0 20px 50px rgba(0,0,0,0.5)' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '24px' }}>
                            <img src="/logo2blanco.png" alt="Lugo Stage" style={{ height: '36px' }} />
                        </div>
            ...
            {showPreloader && (
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', marginBottom: '52px' }}>
                        <img src="/logo2blanco.png" alt="Lugo Stage" style={{ height: '45px', animation: 'pulse 2s infinite' }} className="preloader-text" />
                    </div>
                                        ...
                                        <>
                                            ...
                                            {!isAppNative && (
                                                <div style={{ fontSize: '0.9rem', lineHeight: '1.5' }}>
                                                    ...
                                                    <a href={window.location.origin} target="_blank" rel="noreferrer" style={{ color: '#00bcd4', fontWeight: 'bold', textDecoration: 'none', display: 'inline-block', marginTop: '8px', fontSize: '1rem' }}>{window.location.host}</a>
                                                </div>
                                            )}
                                        </>
                                    ) : (
