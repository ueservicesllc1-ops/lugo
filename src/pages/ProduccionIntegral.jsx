    ...
    return (
        <div style={{ minHeight: '100vh', backgroundColor: '#0f172a', color: 'white', fontFamily: '"Inter", sans-serif' }}>
            ...
            <section style={{ paddingTop: '160px', paddingBottom: '100px', textAlign: 'center', background: 'radial-gradient(circle at top, rgba(139,92,246,0.15) 0%, transparent 60%)' }}>
                <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 20px' }}>
                    <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: '8px 20px', borderRadius: '50px', background: 'rgba(139,92,246,0.1)', border: '1px solid rgba(139,92,246,0.2)', color: '#8B5CF6', fontSize: '0.8rem', fontWeight: '800', marginBottom: '30px', textTransform: 'uppercase', letterSpacing: '2px' }}>
                        <Star size={14} fill="#8B5CF6" /> {t('highLevelService')}
                    </div>
                    <h1 style={{ fontSize: '4.5rem', fontWeight: '900', marginBottom: '24px', letterSpacing: '-2.5px', lineHeight: '1' }}>
                        {t('prodIntegralTitlePart1')} <span style={{ background: 'linear-gradient(to right, #8B5CF6, #D946EF)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{t('prodIntegralTitlePart2')}</span>
                    </h1>
                    ...
                    <div style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', display: 'grid', gap: '30px' }}>
                        {[
                            ...
                            <div key={i} style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', padding: '40px', borderRadius: '24px', transition: 'all 0.3s' }}>
                                <div style={{ marginBottom: '25px', background: 'rgba(139,92,246,0.1)', width: '60px', height: '60px', borderRadius: '15px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    {s.icon}
                                </div>
            ...
            <section style={{ padding: '100px 20px', background: '#0f172a' }}>
                <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                    ...
                    <div style={{ lineHeight: '1.8', fontSize: '1.1rem', color: '#94a3b8' }}>
                        ...
                        <div style={{ marginTop: '40px', padding: '30px', background: 'rgba(139,92,246,0.05)', borderRadius: '16px', borderLeft: '4px solid #8B5CF6' }}>
            ...
            <section style={{ padding: '80px 20px', textAlign: 'center' }}>
                <div style={{ maxWidth: '600px', margin: '0 auto', background: 'linear-gradient(135deg, rgba(139,92,246,0.1), rgba(217,70,239,0.1))', padding: '60px', borderRadius: '40px', border: '1px solid rgba(139,92,246,0.1)' }}>
